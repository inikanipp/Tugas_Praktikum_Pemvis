...
//        jButtonRegisterUser.setBorder(BorderFactory.createLineBorder(Color.decode("#02613c"), 2));
    ...
    @SuppressWarnings("unchecked")
      ...
      private void register() {
        if (jTextFieldUsernameUserRegister.getText().trim().isEmpty() || jPasswordFieldUserRegister.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "isi bang!", "Error", JOptionPane.WARNING_MESSAGE);
        return;
        }
        try{
            String sql = "INSERT INTO user (username, password, level, id_wilayah) VALUES (?, ?, ?, ?)";
             String sql1 = "select * from user";
            java.sql.Connection conn = (Connection) koneksi.getKoneksi();
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setString(1, jTextFieldUsernameUserRegister.getText().trim());
            ps.setString(2, jPasswordFieldUserRegister.getText().trim());
            ps.setInt(3, 1);
            ps.setInt(4, 5);
            ps.executeUpdate();
            ...
            java.sql.ResultSet res = stm.executeQuery(sql1);
             while (res.next()){
                 if(jTextFieldUsernameUserRegister.getText().trim() == res.getString("id_user")){
                     username = res.getInt("id_user");
                 }
            ...
            HomePage.setUsernameHome(jTextFieldUsernameUserRegister.getText().trim());
                        HomePage.setlevelUser(1);
    ...
    private void jButtonUserLoginYellowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUserLoginYellowActionPerformed
        ...
        loginPage registerUser = new loginPage();
